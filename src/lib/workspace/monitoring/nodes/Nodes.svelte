...
<div class="nodes-dashboard" class:dark={isDark}>
	...
	{:else}
		<div
			class="panel"
			style="justify-content: center; align-items: center; height: 300px; border-style: dashed;"
		>
			<div class="ui active loader"></div>
			<span style="margin-top: 3rem; font-weight: 600; color: #6a737d;"
				>Waiting for node metrics...</span
			>
		</div>
	{/if}
</div>
